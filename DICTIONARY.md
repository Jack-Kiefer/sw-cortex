...
- **Staging SERP / darklaunch MySQL DB**: Hetzner at **5.161.233.240**, database `serp_test` (MCP key `serp_test`) — this is the **STAGING SERP DB** (with the darklaunch history), NOT a throwaway test DB and NOT production (**prod is `serp_app`**).
