...
| Table                            | Purpose                                                                                                                                                                                                    |
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `wishdesk.orders_tickets`        | CS support tickets **about** orders (~588 rows as of 2026-08-10, mostly `CLOSED` — a handful `OPEN`/`IN_PROGRESS`/`WAITING_ON_CLIENT`; actively growing, not a static archive) — NOT the orders themselves |
