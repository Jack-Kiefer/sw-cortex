...
- `mcp__task-manager__add_task` with `notifyAt` - Create task with notification
- `mcp__task-manager__list_tasks_with_notifications` - List pending reminders
- `mcp__task-manager__clear_task_notification` - Cancel a reminder
