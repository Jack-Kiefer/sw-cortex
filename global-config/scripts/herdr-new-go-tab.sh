...
# Replaces the old VS Code cmd+shift+enter runCommands binding (new terminal in sw-cortex →
# `claude` → type "/go "). Finds (or creates) the sw-cortex hub workspace, opens a focused
# tab cwd'd at the hub, starts claude, and types "/go " WITHOUT submitting — Jack finishes
# the sentence.
